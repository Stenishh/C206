...
public class NormalDAO extends ConnectionDAO{
    ...
    //INSERT
    public boolean insertUser(Normal user) {
    ...
    //UPDATE
    public boolean updateUser(String nome, Normal user) {
        connectToDB();
    ...
    //SELECT
    public ArrayList<Normal> selectUser() {
        ArrayList<Normal> users = new ArrayList<>();
        connectToDB();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Normal userAux = new Normal(rs.getString("nome"),rs.getString("tipo"),rs.getInt("nivel"),rs.getFloat("peso"));
