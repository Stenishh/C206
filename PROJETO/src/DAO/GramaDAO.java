...
public class GramaDAO extends ConnectionDAO{
    ...
    //INSERT
    public boolean insertUser(Grama user) {
    ...
    //UPDATE
    public boolean updateUser(String nome, Grama user) {
        connectToDB();
    ...
    //SELECT
    public ArrayList<Grama> selectUser() {
        ArrayList<Grama> users = new ArrayList<>();
        connectToDB();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Grama userAux = new Grama(rs.getString("nome"),rs.getString("tipo"),rs.getInt("nivel"),rs.getFloat("peso"));
