...
public class FogoDAO extends ConnectionDAO{
    ...
    //INSERT
    public boolean insertUser(Fogo user) {
    ...
    //UPDATE
    public boolean updateUser(String nome, Fogo user) {
        connectToDB();
    ...
    //SELECT
    public ArrayList<Fogo> selectUser() {
        ArrayList<Fogo> users = new ArrayList<>();
        connectToDB();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Fogo userAux = new Fogo(rs.getString("nome"),rs.getString("tipo"),rs.getInt("nivel"),rs.getFloat("peso"));
