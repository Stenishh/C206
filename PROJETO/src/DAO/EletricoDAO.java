...
public class EletricoDAO extends ConnectionDAO{
    ...
    //INSERT
    public boolean insertUser(Eletrico user) {
    ...
    //UPDATE
    public boolean updateUser(String nome, Eletrico user) {
        connectToDB();
    ...
    //SELECT
    public ArrayList<Eletrico> selectUser() {
        ArrayList<Eletrico> users = new ArrayList<>();
        connectToDB();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Eletrico userAux = new Eletrico(rs.getString("nome"),rs.getString("tipo"),rs.getInt("nivel"),rs.getFloat("peso"));
